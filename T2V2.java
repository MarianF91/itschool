public class T2V2 {
    ...
    public static void main(String[] args) {
        ...
        int cifraPara = 0, cifraImpara = 1, numarPar= 10, numarImpar = 11;
        double numarCuMulteZecimale = 1.23456789, numarNegativ = -1, numarNegativCuMulteZecimale = -1.23456789;
        char literaMare = 'A', literaMica = 'a';
        String propozitieOarecare = "Ana are mere.";

...
public class Challenge5b {
    ...
    public static void main(String[] args) {
        ...
        //we have two "if" loops to verify if your number is higher, lower or equal to 0
        if (number == 0) { //this verifies if the number is 0;
            System.out.println("Use a number higher or lower than 0.");

            if (!(number < 0)) { //next step if the number is higher than 0 (the "true" or "false" result in paranthesis is reversed);
